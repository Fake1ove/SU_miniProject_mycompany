...
<body>
    <div class="container bg-light p-2 my-2">
                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            <tr>
                                ...
                                <td><?= $row["p_price"]; ?></td>
                                <td>
                                    <img src="<?php echo "product_images/" . $row["p_image"]; ?>" class="img-thumbnail"
                                        width="50px" alt="product image">
                                </td>
                                <td><a href="product_edit_form.php?pid=<?= $row["p_id"]; ?>">แก้ไข</a></td>
                                <td><a href="product_delete_save.php?pid=<?= $row["p_id"]; ?>"
        ...
        <button type="button" class="btn btn-primary d-block m-auto"
            onclick="window.location.href='product_add_form.php'">เพิ่มสินค้า</button>
        <br>
